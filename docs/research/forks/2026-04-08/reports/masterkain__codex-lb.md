...
- URL: https://github.com/masterkain/codex-lb
- Снимок: `2026-04-08`
- Default branch: `main`
- Создан форк: `2026-03-26T16:25:37Z`
- Последний push: `2026-03-26T16:26:40Z`
- Веток в форке: `12`
...
- `feat/readme-helm-install-option`: ahead 1, behind 69. По коммитам видно: mention helm install option in readme.
  - Коммиты: mention helm install option in readme.

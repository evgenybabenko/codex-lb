...
- URL: https://github.com/XavLimSG/codex-lb
- Снимок: `2026-04-08`
- Default branch: `main`
- Создан форк: `2026-03-29T08:40:40Z`
- Последний push: `2026-03-29T08:41:54Z`
- Веток в форке: `12`
...
- `fix/stale-usage-after-reset`: ahead 1, behind 69. По коммитам видно: detect stale usage data after account rate-limit/quota reset.
  - Коммиты: detect stale usage data after account rate-limit/quota reset.
  - Основные зоны: `tests/unit` (2), `app/core/balancer` (1), `app/modules/proxy` (1), `app/modules/usage` (1).

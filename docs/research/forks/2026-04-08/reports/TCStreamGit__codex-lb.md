# TCStreamGit/codex-lb

- URL: https://github.com/TCStreamGit/codex-lb
- Снимок: `2026-04-08`
- Default branch: `main`
- Создан форк: `2026-04-04T20:28:26Z`
- Последний push: `2026-04-04T21:44:47Z`
- Веток в форке: `22`
...
- Статус: behind, ahead 0, behind 32.

## Default branch vs наш develop

- Статус: diverged, ahead 10, behind 7.
...
- `feat/account-org-labels`: ahead 4, behind 32. По коммитам видно: add organization labels, grouping, and Windows support; surface org names from nested auth claims and always show grouping toggle; add manual organization override for account naming.
  - Коммиты: add organization labels, grouping, and Windows support; surface org names from nested auth claims and always show grouping toggle; add manual organization override for account naming; add multi-business tags and grouping for accounts.
  - Основные зоны: `frontend/accounts` (7), `app/modules/accounts` (6), `app/db` (3), `app/core/auth` (1).
...
- `feat/deterministic-failover-soft-drain`: ahead 3, behind 32. По коммитам видно: add deterministic failover & soft drain change proposal; implement deterministic failover & soft drain; update tasks.md with implementation status.
  - Коммиты: add deterministic failover & soft drain change proposal; implement deterministic failover & soft drain; update tasks.md with implementation status.
  - Основные зоны: `app/core/balancer` (3), `app/modules/proxy` (3), `openspec` (3), `app/core/config` (1).

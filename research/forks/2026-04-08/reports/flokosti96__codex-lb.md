...
- URL: https://github.com/flokosti96/codex-lb
- Снимок: `2026-04-08`
- Default branch: `main`
- Создан форк: `2026-03-12T10:15:02Z`
- Последний push: `2026-03-13T04:01:27Z`
- Веток в форке: `14`
...
- Статус: behind, ahead 0, behind 122.

## Default branch vs наш develop

- Статус: behind, ahead 0, behind 86.
...
- `chore/add-pyproject-maintainer`: ahead 1, behind 124. По коммитам видно: add maintainer metadata.
  - Коммиты: add maintainer metadata.
...
- `fix/stream-budget-exhaustion`: ahead 1, behind 122. По коммитам видно: decouple stream duration from proxy request budget.
  - Коммиты: decouple stream duration from proxy request budget.
  - Основные зоны: `.agents` (1), `app/core/clients` (1), `app/modules/proxy` (1), `tests/unit` (1).

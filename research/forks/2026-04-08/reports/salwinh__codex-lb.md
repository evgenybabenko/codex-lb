...
- URL: https://github.com/salwinh/codex-lb
- Снимок: `2026-04-08`
- Default branch: `main`
- Создан форк: `2026-04-03T12:27:44Z`
- Последний push: `2026-04-06T00:58:49Z`
- Веток в форке: `21`
...
- Статус: behind, ahead 0, behind 36.

## Default branch vs наш develop

- Статус: diverged, ahead 6, behind 6.
...
- `feat/dashboard-overview-timeframes`: ahead 4, behind 25. По коммитам видно: add selectable dashboard overview timeframes; compute overview summary from exact timeframe window; preserve exact-boundary dashboard trend buckets.
  - Коммиты: add selectable dashboard overview timeframes; compute overview summary from exact timeframe window; preserve exact-boundary dashboard trend buckets.
  - Основные зоны: `frontend/dashboard` (12), `app/modules/dashboard` (5), `openspec` (4), `frontend/src` (3).
...
- `helm/db-init-hook`: ahead 2, behind 40. По коммитам видно: clarify ServiceMonitor and PrometheusRule defaults and alternatives; add db-init pre-install hook for external PostgreSQL.
  - Коммиты: clarify ServiceMonitor and PrometheusRule defaults and alternatives; add db-init pre-install hook for external PostgreSQL.
